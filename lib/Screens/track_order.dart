  ...
  getProduct() async {
    ...
    for (int i = 0; i < orderList[widget.id]["line_items"].length; i++) {
      final response = await woocommerceAPI.getAsync(
          "/" + orderList[widget.id]["line_items"][i]["product_id"].toString());
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          Text(
                                            previousOrderProductList[index]
                                                ["name"],
                                            style: TextStyle(
                                                fontSize: 16,
                                                fontWeight: FontWeight.w600,
                      ...
                      child: Align(
                        ...
                        child: Timeline(
                              ...
                              child: Align(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    getTimeLineDate(orderList[widget.id]
                                            ["date_created"]
                                        .toString())
                                  ],
                                ),
                          ...
                          indicators: <Widget>[
                            ...
                            Icon(
                              Icons.circle,
                              color: getTimeLineColor(orderList[widget.id]
                                      ["date_modified"]
                                  .toString()),
                            ),
                            Icon(
                          ...
                          stat: orderList[widget.id]["status"],
